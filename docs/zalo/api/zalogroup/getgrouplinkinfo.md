# Link: Lấy Thông Tin Nhóm

Lấy thông tin của một nhóm từ link mời

`Group Action → Link: Lấy Thông Tin Nhóm`
...
- **Link Mời Nhóm (bắt buộc)**: Link tham gia nhóm (ví dụ: https://zalo.me/g/xxxxxx)
